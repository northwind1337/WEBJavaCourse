...
public class UserDao extends GetConnectionDao implements UserDaoLayer {
    ...
    @Override
    public User getByLogin(String login) throws DaoExceptionLayer {
    ...
    @Override
    public Long create(User user) throws DaoExceptionLayer {
    ...
    @Override
    public User read(Long id) throws DaoExceptionLayer {
    ...
    @Override
    public void update(User user) throws DaoExceptionLayer {

...
public class AssignmentDaoImpl extends BaseDaoImpl implements AssignmentDao {
    ...
    @Override
    public List<Assignment> getAssignments() throws DaoException {
    ...
    @Override
    public Assignment getAssignmentFromResultSet(ResultSet resultSet) throws DaoException {
        try {
            Assignment assignment = new Assignment();
            assignment.setId(resultSet.getLong("id"));
            assignment.setStudent(new Student());
	...
	@Override
	public Assignment getByStudentAndCourse(Long studentId, Long courseId) throws DaoException {
